...
public class RestAuthHiddenValueCallbackHandler extends AbstractRestAuthCallbackHandler<HiddenValueCallback> {
    ...
    boolean doUpdateCallbackFromRequest(HttpHeaders headers, HttpServletRequest request, HttpServletResponse response,
            HiddenValueCallback callback) throws RestAuthCallbackHandlerResponseException {
        return false;
    }
     ...
     */
    @Override
    public HiddenValueCallback handle(HttpHeaders headers, HttpServletRequest request, HttpServletResponse response,
