...
public class ExtendedScopeImplTest extends PowerMockTestCase {

    ExtendedScopeImpl scopeImpl = null;
    ...
    public void testGetDefaultScopeForScopeToPresentOnAuthorizationPage() {
        ...
        scopeImpl = new ExtendedScopeImpl(store, id);
    ...
    public void testGetUserInfo(){
        ...
        assert(returnValues.containsKey("extended_field") && returnValues.get("extended_field").equals("attributeValue"));
    }
