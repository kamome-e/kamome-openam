 ...
 */
public class ExtendedScopeImpl implements Scope {
    ...
    static {
        ...
        scopeToUserUserProfileAttributes.put("extended_field", "extended_field");
    ...
    public ExtendedScopeImpl(){
        this.store = InjectorHolder.getInstance(DefaultOAuthTokenStoreImpl.class);
        this.id = null;
    }

    public ExtendedScopeImpl(OAuth2TokenStore store, AMIdentity id){
        this.store = store;
        this.id = id;
    }
    ...
    public Map<String, Object> extraDataToReturnForTokenEndpoint(Map<String, String> parameters, CoreToken token){
        ...
        if (scope != null && scope.contains(OPENID_SCOPE)){
            ...
            try {
                ...
                OAuth2Utils.DEBUG.error("ExtendedScopeImpl.extraDataToReturnForTokenEndpoint()::Unable to sign JWT", e);
...
//            }
    ...
    public Map<String,Object> getUserInfo(CoreToken token){
        ...
        for(String scope: scopes){
            ...
            if (attributes == null){
             OAuth2Utils.DEBUG.error("ExtendedScopeImpl.getUserInfo()::Invalid Scope in token scope="+ scope);
                ...
                try {
                    ...
                    OAuth2Utils.DEBUG.error("ExtendedScopeImpl.getUserInfo(): Unable to retrieve atrribute", e);
                ...
                if (attr != null && attr.size() == 1){
                    ...
                    OAuth2Utils.DEBUG.error("ExtendedScopeImpl.getUserInfo(): Got an empty result for scope=" + scope);
                }
